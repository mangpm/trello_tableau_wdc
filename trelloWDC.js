(function () {
      ...
      // Custom Fields - Card Level schema
        ...
        // Custom Fields - Option Level
          ...
          var custFieldsOLTableSchema = {
              ...
              alias: 'Custom Fields - Option Level Data',
              columns: custFieldsOL_cols
          };


        schemaCallback([boardTableSchema, listTableSchema, cardTableSchema, custFieldsBLTableSchema, custFieldsCLTableSchema, custFieldsOLTableSchema]);
    };
    ...
    myConnector.getData = function(table, doneCallback) {
        ...
        $.getJSON(apiCall, function(resp) {
          ...
          //Custom Fields -  Option Level Data Table
            ...
            resp.customFields.forEach(function(field) {
              if (typeof field.options !== 'undefined') {
                field.options.forEach(function(option) {
                  ...
                  data['optionColor'] = option.color
                  data['optionValue'] = option.value.text
                  tableData.push(data)
                })
              }
            })
